...
-- AddForeignKey
ALTER TABLE "order_items" ADD CONSTRAINT "order_items_rentalOrderId_fkey" FOREIGN KEY ("rentalOrderId") REFERENCES "rental_orders"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
